...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/java-inputoutput0118/1?page=2&category=Java&sortBy=difficulty)

## Solved On
03 Aug 2026 at 12:46 pm

<h2><a href="https://www.geeksforgeeks.org/problems/java-inputoutput0118/1?page=2&category=Java&sortBy=difficulty">Java Input/Output</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size:18px">Given a string S and an integer number N, print the output in the form: "The input string :S" and "The input integer :N" in the two separate lines.</span></p>
